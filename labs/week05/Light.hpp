...
public:
	...
	virtual Eigen::Vector3f getDirection(const Eigen::Vector3f& surfaceLocation) override
	{
		...
		// *** YOUR CODE HERE ***
		std::cout << "Ambient Lights have no direction!\n";
	...
	virtual Eigen::Vector3f getLightLocation() override
	{
		...
		// *** YOUR CODE HERE ***
		std::cout << "Ambient Lights have no location!\n";
		return Eigen::Vector3f::Zero();
		// *** END YOUR CODE ***
	}
};
...
public:
	...
	virtual Eigen::Vector3f getIntensityAt(const Eigen::Vector3f& surfaceLocation) override
	{
		...
		// square law.
		// *** YOUR CODE HERE ***
		Eigen::Vector3f lightSurfaceDist = _location - surfaceLocation;
		return _intensity * (1 / pow(lightSurfaceDist.x(), 2) + pow(lightSurfaceDist.y(), 2) + pow(lightSurfaceDist.z(), 2));
		// *** END YOUR CODE ***
	}
	...
	virtual Eigen::Vector3f getDirection(const Eigen::Vector3f& surfaceLocation) override
	{
		...
		// *** YOUR CODE HERE ***
		return (_location - surfaceLocation).normalized();
		// *** END YOUR CODE ***
	}
...
public:
	...
	virtual Eigen::Vector3f getIntensityAt(const Eigen::Vector3f& surfaceLocation) override
	{
		...
		// *** YOUR CODE HERE ***
		if (getDirection(surfaceLocation).dot(_direction) < _cosAngle) {
			Eigen::Vector3f lightSurfaceDist = _location - surfaceLocation;
			return _intensity * (1 / pow(lightSurfaceDist.x(), 2) + pow(lightSurfaceDist.y(), 2) + pow(lightSurfaceDist.z(), 2));
		}
		else {
